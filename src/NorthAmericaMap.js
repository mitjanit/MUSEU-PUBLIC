...
const include = [
    "Canada", "United States of America", "Mexico", "The Bahamas", "Cuba", "Jamaica", "Haiti", "Dominican Republic",
...
class NorthAmericaMap extends Component {

  constructor(props) {
    super(props);
    this.state = { open: false, continent: "North America", toCountry: false, country: null };
    ...
    return (
      ...
      <div style={wrapperStyles}>
        <ComposableMap
          ...
          >
          <ZoomableGroup center={[-100,50]} disablePanning>
        ...
        <ReactTooltip id="northamericatip" />
      </div>
